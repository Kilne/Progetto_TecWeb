function fetch_the_projects_data(html_element) {
    fetch("/projects/data", {
        method: "POST",
        mode: "cors",
        body: JSON.stringify({
...
function clear_the_projects_area() {
    let html_element = document.getElementById("project_list_column");
    html_element.innerHTML = "";
}
function project_element_builder(project_container, html_element) {
