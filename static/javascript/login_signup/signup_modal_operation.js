...
document.addEventListener("click", (event) => {
    ...
    if (submit_button.id === "modal_signup_box_submit_field_submit_button") {
        ...
        const email_input_value = document.getElementById("modal_signup_box_email_field_email_input");
        const username_input_value = document.getElementById("modal_signup_box_user_field_user_input");
        const password_input_value = document.getElementById("modal_signup_box_password_field_password_input");
        // Elementi che contengono i contenitori dei form
        const html_email_element = document.getElementById("modal_signup_box_email_field");
        const html_username_element = document.getElementById("modal_signup_box_user_field_user");
        const html_password_element = document.getElementById("modal_signup_box_password_field_password");
        ...
        const email_warn_element = document.getElementById("email_warn");
        const username_warn_element = document.getElementById("username_warn");
        const password_warn_element = document.getElementById("password_warn");
        ...
        if (!checks.email_check ||
            ...
            alert("Some fields did not pass a preliminary check, please review your data.");
            ...
            fetch("/signup", {
                ...
                response.json().then((data) => {
                    if (data.Response === true) {
                        // Successo e redirect
                        alert("User created successfully, you'll be redirected to your page page after pressing ok.");
