document.addEventListener("DOMContentLoaded", function () {
  const nav_button_collection = document.getElementsByClassName(
    "buttons"
  ...
  const nav_bar_end_element = document.getElementById(
    "tapp_nav_items_menu_end_buttons"
  ) as HTMLElement;
