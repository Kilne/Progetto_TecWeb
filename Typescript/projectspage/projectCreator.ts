document.addEventListener("DOMContentLoaded", function () {
    let modal_root: HTMLElement = document.getElementById("project_creator");
...
function project_creator(){
    ...
    let name_input: string = (
        document.getElementById("project_creator_modal_box_field_name_input_field") as HTMLInputElement).value;
    let obj_input: string = (
        document.getElementById(
            "project_creator_modal_box_field_objective_input_field") as HTMLInputElement).value;
    let goal_input: number = parseInt((
        document.getElementById(
            "project_creator_modal_box_field_goal_input_field") as HTMLInputElement).value);
    let description_input: string = (
        document.getElementById(
            "project_creator_modal_box_field_description_input_field") as HTMLInputElement).value;
    let due_date_input: Date = new Date((
        document.getElementById(
            "project_creator_modal_box_field_date_input_field") as HTMLInputElement).value);
    ...
    let new_orm: data_orm = {
        "p_name": name_input,
        "obj": obj_input,
        "goal": goal_input,
        "num_steps_total":   Math.floor((due_date_input.getTime()- new Date(Date()).getTime()) /(86400 * 1000)),
        "num_steps_completed": 0,
        "single_step_value": goal_input / Math.floor(
            (due_date_input.getTime()- new Date(Date()).getTime()) /(86400 * 1000)),
    ...
    if (proceed !== false) {
        fetch("/projects/create", {
            ...
            if (data["data"] === true) {
                ...
                document.getElementById(
                    "project_creator_modal_box_field_name_input_field").classList.remove("is-danger");
                document.getElementById(
                    "project_creator_modal_box_field_goal_input_field").classList.remove("is-danger");
                document.getElementById(
                    "project_creator_modal_box_field_date_input_field").classList.remove("is-danger");
                document.getElementById(
                    "project_creator_modal_box_field_objective_input_field").
                classList.remove("is-danger");
                document.getElementById(
                    "project_creator_modal_box_field_description_input_field").
                classList.remove("is-danger");
                name_input = "";
                obj_input = "";
                goal_input = 0;
